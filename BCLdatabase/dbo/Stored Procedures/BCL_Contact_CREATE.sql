...
-- =============================================
CREATE PROCEDURE [dbo].[BCL_Contact_CREATE]
...
BEGIN
	...
	Insert Into BCL_Contact (Name_First, Name_Middle, Name_Second, Description, AddressStreet, AddressUnit, AddressCity, AddressState, AddressZip, IsActive, IsDeleted)

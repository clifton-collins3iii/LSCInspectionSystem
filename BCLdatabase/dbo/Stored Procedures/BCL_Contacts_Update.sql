...
-- =============================================
CREATE PROCEDURE [dbo].[BCL_Contacts_Update]
...
BEGIN
	...
	Update BCL_Contacts
	Set Contacts_Name = @Contacts_Name, ContactsDescription = @ContactsDescription, AddressStreet = @AddressStreet,
		AddressUnit = @AddressUnit, AddressCity = @AddressCity, AddressState = @AddressState, AddressZip = @AddressZip,
		IsActive = @IsActive, IsDeleted = @IsDeleted, MobilePhoneNumber = @MobilePhoneNumber, EmailAddress = @EmailAddress
